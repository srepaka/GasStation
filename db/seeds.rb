...
EntryCategory.create(category: "Correction", entry_type_id: EntryType.find_by(entry_type: "Credit").id)
...
EntryCategory.create(category: "Bank Fees", entry_type_id: EntryType.find_by(entry_type: "Debit").id)
EntryCategory.create(category: "Correction", entry_type_id: EntryType.find_by(entry_type: "Debit").id)
